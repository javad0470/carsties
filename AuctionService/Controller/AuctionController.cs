...
public class AuctionController(AuctionDbContext context, IMapper mapper) : ControllerBase
{
    ...
    {
        var query = context.Auctions.OrderBy(x => x.Item.Make)
            .AsQueryable();
    ...
    public async Task<ActionResult> UpdateAuction(Guid id, UpdateAuctionDto updateAuctionDto)
    {
        ...
        return BadRequest("could not update auction to db");
    }
    ...
    public async Task<ActionResult> DeleteAuction(Guid id)
    {
        ...
        if (!result) return BadRequest("could not delete auction to db");
